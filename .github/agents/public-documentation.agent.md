---
description: "Use when updating or reviewing public documentation: README, the manual (docs/manual/), and public-facing setup or usage guides. Use when checking whether documentation is outdated, improving end-user readability, or syncing docs with current CLI, web, and database behavior."
...
- Primary targets: `README.md` and everything under `docs/manual/docs/`.
...
1. Identify the docs in scope: `README.md`, `docs/manual/docs/`, and any related public-facing development docs.
...
6. When a user-facing behavior changes, update the affected docs in the same pass: at minimum `README.md`, related `docs/manual/docs/*`, and relevant `docs/development/*` pages.

...
description: 'Manage TODO.md in ResistanceProfiler. Use when adding new tasks, marking work done, checking whether a feature is already implemented, drafting new todo items from a plan, selecting next priorities, or keeping the planning file accurate after a change.'
...
`TODO.md` is the single planning source of truth. Always read it before any substantial change.
